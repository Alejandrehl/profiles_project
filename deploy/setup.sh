...
PROJECT_GIT_URL='https://github.com/Alejandrehl/profiles_project.git'

PROJECT_BASE_PATH='/usr/local/apps/profiles-rest-api'

echo "Installing dependencies..."
apt-get update
apt-get install -y python3-dev python3-venv sqlite python3-pip python3-wheel supervisor nginx git
...
$PROJECT_BASE_PATH/env/bin/pip install wheel
